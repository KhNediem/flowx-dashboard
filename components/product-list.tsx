...
export function ProductList() {
  ...
  const handleEditProduct = async (data: Product) => {
    const { error } = await supabase.from("products").update(data).eq("product_id", data.product_id)
    ...
    <div className="space-y-4">
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent>
          ...
          <ProductForm form={addForm} onSubmit={handleAddProduct} dialogTitle="Add Product" />
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          ...
          <ProductForm form={editForm} onSubmit={handleEditProduct} dialogTitle="Update Product" />
        </DialogContent>
      </Dialog>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="grid gap-2">
                    ...
                    <p>
                      <strong>Brand:</strong> {getBrandName(selectedProduct.brand_id)}
                    </p>
                    <p>
